...
object TestUtil {
    ...
    fun createStory(): Story {
        ...
        val title = RandomStringUtils.insecure().next(20)
        val detailedText = RandomStringUtils.insecure().next(20)
    ...
    fun createUserDto(): UserDTO {
        val id = null
        val username = RandomStringUtils.insecure().next(20)
        val password = RandomStringUtils.insecure().next(20)
    ...
    fun createPageDto(): PageDTO {
        val id = null
        val text = RandomStringUtils.insecure().next(20)
        val image = RandomStringUtils.insecure().next(20)
